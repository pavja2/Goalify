...
/**
 * Base class that represents a row from the 'balance' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Balance implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\BalanceTableMap';
    ...
    /**
     * Compares this with another <code>Balance</code> instance.  If
     * <code>obj</code> is an instance of <code>Balance</code>, delegates to
     * <code>equals(Balance)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Balance The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[BalanceTableMap::COL_ID] = true;
        }
    ...
    public function setAmount($v)
    {
        ...
        if ($this->amount !== $v) {
            $this->amount = $v;
            $this->modifiedColumns[BalanceTableMap::COL_AMOUNT] = true;
        }
    ...
    public function setPaymentInfo($v)
    {
        ...
        if ($this->payment_info !== $v) {
            $this->payment_info = $v;
            $this->modifiedColumns[BalanceTableMap::COL_PAYMENT_INFO] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBalanceQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Balance::setDeleted()
     * @see Balance::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildBalanceQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BalanceTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BalanceTableMap::COL_PAYMENT_INFO)) {
            $modifiedColumns[':p' . $index++]  = 'payment_info';
        }

        $sql = sprintf(
            'INSERT INTO balance (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'amount':
                        ...
                        break;
                    case 'payment_info':
                        $stmt->bindValue($identifier, $this->payment_info, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = BalanceTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Balance'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Balance'][$this->hashCode()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BalanceTableMap::COL_PAYMENT_INFO)) {
            $criteria->add(BalanceTableMap::COL_PAYMENT_INFO, $this->payment_info);
        }
    ...
    {
        $criteria = ChildBalanceQuery::create();
        $criteria->add(BalanceTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Balance (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Balance Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildBalance is new, it will return
    ...
    {
        return (string) $this->exportTo(BalanceTableMap::DEFAULT_STRING_FORMAT);
    }
