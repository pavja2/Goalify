...
/**
 * Base class that represents a row from the 'campaign_status' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class CampaignStatus implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CampaignStatusTableMap';
    ...
    /**
     * Initializes internal state of Base\CampaignStatus object.
     */
    ...
    /**
     * Compares this with another <code>CampaignStatus</code> instance.  If
     * <code>obj</code> is an instance of <code>CampaignStatus</code>, delegates to
     * <code>equals(CampaignStatus)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CampaignStatus The current object, for fluid interface
     */
     ...
     * @return $this|\CampaignStatus The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CampaignStatusTableMap::COL_ID] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[CampaignStatusTableMap::COL_STATUS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CampaignStatusTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CampaignStatusTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = CampaignStatusTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CampaignStatus'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCampaignStatusQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CampaignStatus::setDeleted()
     * @see CampaignStatus::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCampaignStatusQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CampaignStatusTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CampaignStatusTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(CampaignStatusTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }

        $sql = sprintf(
            'INSERT INTO campaign_status (%s) VALUES (%s)',
    ...
    {
        $pos = CampaignStatusTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['CampaignStatus'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CampaignStatus'][$this->hashCode()] = true;
        $keys = CampaignStatusTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CampaignStatusTableMap::COL_ID)) {
            $criteria->add(CampaignStatusTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(CampaignStatusTableMap::COL_STATUS)) {
            $criteria->add(CampaignStatusTableMap::COL_STATUS, $this->status);
        }
    ...
    {
        $criteria = ChildCampaignStatusQuery::create();
        $criteria->add(CampaignStatusTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CampaignStatus (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CampaignStatus Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildCampaignStatus is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildCampaignStatus The current object (for fluent API support)
     */
    public function setCampaigns(Collection $campaigns, ConnectionInterface $con = null)
    {
        ...
        foreach ($campaignsToDelete as $campaignRemoved) {
            $campaignRemoved->setCampaignStatus(null);
        }
    ...
    protected function doAddCampaign(ChildCampaign $campaign)
    {
        ...
        $campaign->setCampaignStatus($this);
    }
     ...
     * Otherwise if this CampaignStatus is new, it will return
     * an empty collection; or if this CampaignStatus has previously
     * been saved, it will retrieve related Campaigns from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CampaignStatus.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(CampaignStatusTableMap::DEFAULT_STRING_FORMAT);
    }
