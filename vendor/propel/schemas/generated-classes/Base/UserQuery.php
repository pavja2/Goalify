 ...
 *
 * @method     ChildUserQuery leftJoinPartnershipRelatedByUserId($relationAlias = null) Adds a LEFT JOIN clause to the query using the PartnershipRelatedByUserId relation
 * @method     ChildUserQuery rightJoinPartnershipRelatedByUserId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PartnershipRelatedByUserId relation
 * @method     ChildUserQuery innerJoinPartnershipRelatedByUserId($relationAlias = null) Adds a INNER JOIN clause to the query using the PartnershipRelatedByUserId relation
 *
 * @method     ChildUserQuery leftJoinPartnershipRelatedByPartnerId($relationAlias = null) Adds a LEFT JOIN clause to the query using the PartnershipRelatedByPartnerId relation
 * @method     ChildUserQuery rightJoinPartnershipRelatedByPartnerId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PartnershipRelatedByPartnerId relation
 * @method     ChildUserQuery innerJoinPartnershipRelatedByPartnerId($relationAlias = null) Adds a INNER JOIN clause to the query using the PartnershipRelatedByPartnerId relation
 *
 * @method     \PartnershipQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class UserQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'hophacks', $modelName = '\\User', $modelAlias = null)
    {
    ...
    public function filterByLastActive($lastActive = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserTableMap::COL_LAST_ACTIVE, $lastActive, $comparison);
    }
    ...
    public function filterByScore($score = null, $comparison = null)
    {
        if (is_array($score)) {
            $useMinMax = false;
            if (isset($score['min'])) {
                $this->addUsingAlias(UserTableMap::COL_SCORE, $score['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($score['max'])) {
                $this->addUsingAlias(UserTableMap::COL_SCORE, $score['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
     ...
     */
    public function filterByPartnershipRelatedByUserId($partnership, $comparison = null)
    {
        if ($partnership instanceof \Partnership) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $partnership->getUserId(), $comparison);
        } elseif ($partnership instanceof ObjectCollection) {
            return $this
                ->usePartnershipRelatedByUserIdQuery()
                ->filterByPrimaryKeys($partnership->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByPartnershipRelatedByUserId() only accepts arguments of type \Partnership or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the PartnershipRelatedByUserId relation
     *
     ...
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function joinPartnershipRelatedByUserId($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('PartnershipRelatedByUserId');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'PartnershipRelatedByUserId');
        }
    ...
    /**
     * Use the PartnershipRelatedByUserId relation Partnership object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function usePartnershipRelatedByUserIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinPartnershipRelatedByUserId($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'PartnershipRelatedByUserId', '\PartnershipQuery');
    }
     ...
     * @return ChildUserQuery The current query, for fluid interface
     */
    public function filterByPartnershipRelatedByPartnerId($partnership, $comparison = null)
    {
        if ($partnership instanceof \Partnership) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $partnership->getPartnerId(), $comparison);
        } elseif ($partnership instanceof ObjectCollection) {
            return $this
                ->usePartnershipRelatedByPartnerIdQuery()
                ->filterByPrimaryKeys($partnership->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByPartnershipRelatedByPartnerId() only accepts arguments of type \Partnership or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the PartnershipRelatedByPartnerId relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function joinPartnershipRelatedByPartnerId($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('PartnershipRelatedByPartnerId');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'PartnershipRelatedByPartnerId');
        }
    ...
    /**
     * Use the PartnershipRelatedByPartnerId relation Partnership object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return \PartnershipQuery A secondary query class using the current class as primary query
     */
    public function usePartnershipRelatedByPartnerIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinPartnershipRelatedByPartnerId($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'PartnershipRelatedByPartnerId', '\PartnershipQuery');
    }
