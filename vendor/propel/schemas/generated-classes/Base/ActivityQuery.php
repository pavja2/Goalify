 ...
 *
 * @method     ChildActivityQuery leftJoinCampaign($relationAlias = null) Adds a LEFT JOIN clause to the query using the Campaign relation
 * @method     ChildActivityQuery rightJoinCampaign($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Campaign relation
 * @method     ChildActivityQuery innerJoinCampaign($relationAlias = null) Adds a INNER JOIN clause to the query using the Campaign relation
 *
...
abstract class ActivityQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'hophacks', $modelName = '\\Activity', $modelAlias = null)
    {
    ...
    public function filterByCampaign($campaign, $comparison = null)
    {
        if ($campaign instanceof \Campaign) {
            return $this
                ->addUsingAlias(ActivityTableMap::COL_ID, $campaign->getActivityId(), $comparison);
