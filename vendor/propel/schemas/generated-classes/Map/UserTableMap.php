...
class UserTableMap extends TableMap
{
     ...
     */
    const COL_LAST_ACTIVE = 'user.last_active';
    ...
    {
        $this->addRelation('PartnershipRelatedByUserId', '\\Partnership', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
  ),
), null, null, 'PartnershipsRelatedByUserId', false);
        $this->addRelation('PartnershipRelatedByPartnerId', '\\Partnership', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':partner_id',
    1 => ':id',
  ),
), null, null, 'PartnershipsRelatedByPartnerId', false);
    } // buildRelations()
